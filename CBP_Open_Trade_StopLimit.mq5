...
input string Order_Price_ID = "ID12345";
...
void OnStart()
   ...
   */
   ...
   if(Script_Open_Order == "STOPLIMIT_SELL")
     {
      bridge.Open_Trade_StopLimit(Exchange_Symbol_Name,"SELL","STOP_LOSS_LIMIT",DoubleToString(Exchange_Lotsize,Exchange_Lot_Precision),Order_Price,Order_Price_Trigger,Exchange_Quote_Precision, Exchange_Lot_Precision,Exchange_Number,"");
     }
     
   if(Script_Open_Order == "STOPLIMIT_BUY")
     {
      bridge.Open_Trade_StopLimit(Exchange_Symbol_Name,"BUY","STOP_LOSS_LIMIT",DoubleToString(Exchange_Lotsize,Exchange_Lot_Precision),Order_Price,Order_Price_Trigger,Exchange_Quote_Precision, Exchange_Lot_Precision,Exchange_Number,"");
     }
